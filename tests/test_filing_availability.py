...
class FilingAvailabilityTests(unittest.TestCase):
    ...
    def test_rejects_unverified_and_ambiguous_filing(self):
        row = {"stock_id": "3037", "report_date": "2025-03-31", "published_at": "2025-05-01T18:00:00+08:00", "source_url": "https://mops.twse.com.tw/example", "document_type": "quarterly_financial_report"}
